...
Redoid.turnOff = function()
{
    return this.changeTo('#000000');
};
...
/**
 * If set to `true` completed transition steps will be added to the end
 * of the queue resulting in a never-ending transition loop.
 *
 * @return {Boolean} loopTransition
 * @return {Redoid} for chaining
 * @public
 */
